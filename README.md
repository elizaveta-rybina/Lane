...
Скрипт сам найдёт Java 17, соберёт проект и запустит `Main`.

Если нужно передать свой видеофайл:

```bash
./run.sh /path/to/video.mp4
```

Если Java 17 уже настроена вручную, можно также запускать через Maven:
